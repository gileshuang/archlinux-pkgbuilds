...
try_start() {
    ...
    BWRAP_ARGS+=(
        ...
        --ro-bind-try "${HOME}/.cache/fontconfig"{,}
        ...
        --ro-bind "${XDG_RUNTIME_DIR}"{,}
        --bind-try "${XDG_RUNTIME_DIR}/${WAYLAND_DISPLAY}"{,}
        --bind-try "${XDG_RUNTIME_DIR}/dconf"{,}
